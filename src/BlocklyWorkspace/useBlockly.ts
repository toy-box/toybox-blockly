...
function importFromXml(xml: string, workspace: Blockly.WorkspaceSvg, onImportXmlError?: (e: any) => void) {
  try {
...
export interface IUseBlockWorkspaceProps extends IBlocklyWorkspaceProps {
